...
namespace OAuthServer.Events
{
    ...
    /// </summary> 
    public abstract class EndpointContext<TOptions> : BaseContext<TOptions> where TOptions : AuthenticationSchemeOptions
    {
        /// <summary> 
        /// Creates an instance of this context 
        /// </summary> 
        protected EndpointContext(HttpContext context, TOptions options, AuthenticationScheme scheme)
