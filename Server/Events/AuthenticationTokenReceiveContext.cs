...
namespace OAuthServer.Events
{
    public class AuthenticationTokenReceiveContext : BaseContext<OAuthServerOptions>
    {
        ...
        public AuthenticationTokenReceiveContext(HttpContext context, AuthenticationScheme scheme, OAuthServerOptions options, ISecureDataFormat<AuthenticationTicket> secureDataFormat, string token)
