...
{
    public class OAuthServerEvents : IOAuthServerEvents
    {
        /// <summary>
        /// Creates new instance of default provider behavior
        /// </summary>
        public OAuthServerEvents()
        {
        ...
        /// </summary>
        public Func<OAuthServerMatchEndpointContext, Task> OnMatchEndpoint { get; set; }
        ...
        /// </summary>
        public Func<OAuthServerValidateClientRedirectUriContext, Task> OnValidateClientRedirectUri { get; set; }
        ...
        /// If context.Validated is not called the request will not proceed further. 
        /// </summary>
        public Func<OAuthServerValidateClientAuthenticationContext, Task> OnValidateClientAuthentication { get; set; }
        ...
        /// </summary>
        public Func<OAuthServerValidateTokenRequestContext, Task> OnValidateTokenRequest { get; set; }
        ...
        /// </summary>
        public Func<OAuthServerGrantAuthorizationCodeContext, Task> OnGrantAuthorizationCode { get; set; }
        ...
        /// </summary>
        public Func<OAuthServerGrantResourceOwnerCredentialsContext, Task> OnGrantResourceOwnerCredentials { get; set; }
        ...
        /// </summary>
        public Func<OAuthServerGrantClientCredentialsContext, Task> OnGrantClientCredentials { get; set; }
        ...
        /// </summary>
        public Func<OAuthServerGrantRefreshTokenContext, Task> OnGrantRefreshToken { get; set; }
        ...
        /// </summary>
        public Func<OAuthServerGrantCustomExtensionContext, Task> OnGrantCustomExtension { get; set; }
        ...
        /// </summary>
        public Func<OAuthServerEndpointContext, Task> OnAuthorizeEndpoint { get; set; }
        ...
        /// </summary>
        public Func<OAuthServerTokenEndpointContext, Task> OnTokenEndpoint { get; set; }
        ...
        public Func<OAuthServerEndpointResponseContext, Task> OnAuthorizationEndpointResponse { get; set; }
        ...
        public Task AuthorizationEndpointResponse(OAuthServerEndpointResponseContext context)
        {
            return OnAuthorizationEndpointResponse.Invoke(context);
        }

        public Task AuthorizeEndpoint(OAuthServerEndpointContext context)
        {
            return OnAuthorizeEndpoint.Invoke(context);
        }

        public Task GrantAuthorizationCode(OAuthServerGrantAuthorizationCodeContext context)
        {
            return OnGrantAuthorizationCode.Invoke(context);
        }

        public Task GrantCustomExtension(OAuthServerGrantCustomExtensionContext context)
        {
            return OnGrantCustomExtension.Invoke(context);
        }

        public Task GrantRefreshToken(OAuthServerGrantRefreshTokenContext context)
        {
            return OnGrantRefreshToken.Invoke(context);
        }

        public Task MatchEndpoint(OAuthServerMatchEndpointContext context)
        {
            return OnMatchEndpoint.Invoke(context);
        }

        public Task TokenEndpoint(OAuthServerTokenEndpointContext context)
        {
        ...
        public Task ValidateClientAuthentication(OAuthServerValidateClientAuthenticationContext context)
        {
            return OnValidateClientAuthentication.Invoke(context);
        }

        public Task ValidateClientRedirectUri(OAuthServerValidateClientRedirectUriContext context)
        {
            return OnValidateClientRedirectUri.Invoke(context);
        }

        public Task ValidateTokenRequest(OAuthServerValidateTokenRequestContext context)
        {
            return OnValidateTokenRequest.Invoke(context);
        }

        public Task GrantResourceOwnerCredentials(OAuthServerGrantResourceOwnerCredentialsContext context)
        {
            return OnGrantResourceOwnerCredentials.Invoke(context);
        }

        public Task GrantClientCredentials(OAuthServerGrantClientCredentialsContext context)
        {
