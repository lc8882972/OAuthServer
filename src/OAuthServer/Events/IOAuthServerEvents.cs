...
{
    public interface IOAuthServerEvents
    {
        ////// <summary>
        ...
        Task MatchEndpoint(OAuthServerMatchEndpointContext context);
        ...
        /// <param name="context">The context of the event carries information in and results out.</param>
        /// <returns>Task to enable asynchronous execution</returns>
        Task ValidateClientRedirectUri(OAuthServerValidateClientRedirectUriContext context);
        ...
        /// <param name="context">The context of the event carries information in and results out.</param>
        /// <returns>Task to enable asynchronous execution</returns>
        Task ValidateClientAuthentication(OAuthServerValidateClientAuthenticationContext context);
        ...
        /// <param name="context">The context of the event carries information in and results out.</param>
        /// <returns>Task to enable asynchronous execution</returns>
        Task ValidateTokenRequest(OAuthServerValidateTokenRequestContext context);
        ...
        /// <param name="context">The context of the event carries information in and results out.</param>
        /// <returns>Task to enable asynchronous execution</returns>
        Task GrantAuthorizationCode(OAuthServerGrantAuthorizationCodeContext context);
        ...
        /// <param name="context">The context of the event carries information in and results out.</param>
        /// <returns>Task to enable asynchronous execution</returns>
        Task GrantRefreshToken(OAuthServerGrantRefreshTokenContext context);
        ...
        /// <param name="context">The context of the event carries information in and results out.</param>
        /// <returns>Task to enable asynchronous execution</returns>
        Task GrantResourceOwnerCredentials(OAuthServerGrantResourceOwnerCredentialsContext context);
        ...
        /// <param name="context">The context of the event carries information in and results out.</param>
        /// <returns>Task to enable asynchronous execution</returns>
        Task GrantClientCredentials(OAuthServerGrantClientCredentialsContext context);
        ...
        /// <param name="context">The context of the event carries information in and results out.</param>
        /// <returns>Task to enable asynchronous execution</returns>
        Task GrantCustomExtension(OAuthServerGrantCustomExtensionContext context);
        ...
        /// <param name="context">The context of the event carries information in and results out.</param>
        /// <returns>Task to enable asynchronous execution</returns>
        Task AuthorizeEndpoint(OAuthServerEndpointContext context);
        ...
        /// <param name="context">The context of the event carries information in and results out.</param>
        /// <returns>Task to enable asynchronous execution</returns>
        Task TokenEndpoint(OAuthServerTokenEndpointContext context);
        ...
        /// <param name="context">The context of the event carries information in and results out.</param>
        /// <returns>Task to enable asynchronous execution</returns>
        Task AuthorizationEndpointResponse(OAuthServerEndpointResponseContext context);
